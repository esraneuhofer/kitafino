...
function getHtmlReminder(accountBalance:number):string{
...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="de">
 <head>
  ...
  <title>Kopie von (1) Neue Vorlage</title><!--[if (mso 16)]>
    <style type="text/css">
...
export function getEmailBodyAccountBalance(tenantStudent: TenantStudentInterface,accountBalance:number){
  return {
    from: '"Cateringexpert" <noreply@cateringexpert.de>',
    to: tenantStudent.email, // list of receivers
    subject: 'Erinnerung Konto aufladen✔', // Subject line
    html: getHtmlReminder(accountBalance)
  };
